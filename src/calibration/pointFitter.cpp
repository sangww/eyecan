...
void pointFitter::setupDimension(int _nDivisionsWidth, int _nDivisionsHeight){	
	nDivisionsWidth = _nDivisionsWidth;
	nDivisionsHeight = _nDivisionsHeight;
}
...
void pointFitter::calculate(ofRectangle & calibrationRectangle){		
	...
	if (numberThreshoodForEachPoint(2))  removePointsFarFromAverage();
