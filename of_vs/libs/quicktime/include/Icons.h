...
/* Special folders */
/* //temporarily blocked for VS2010 compatibility
enum {
    ...
    kHelpFolderIcon             = FOUR_CHAR_CODE('elp'),
    kInternetFolderIcon         = FOUR_CHAR_CODE('int」'),
    kInternetPlugInFolderIcon   = FOUR_CHAR_CODE('iet'),
    kLocalesFolderIcon          = FOUR_CHAR_CODE('ioc'),
    ...
    kPrinterDriverFolderIcon    = FOUR_CHAR_CODE('��rd'),
    ...
    kScriptingAdditionsFolderIcon = FOUR_CHAR_CODE('ocr'),
    kSharedLibrariesFolderIcon  = FOUR_CHAR_CODE('iib'),
    ...
    kTextEncodingsFolderIcon    = FOUR_CHAR_CODE('oex'),
